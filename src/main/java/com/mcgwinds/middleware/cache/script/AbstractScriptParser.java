package com.mcgwinds.middleware.cache.script;
...
public abstract class AbstractScriptParser {
     ...
     * @throws Exception 异常
     */
    public boolean isCacheable(KeyCache cache, Object[] arguments) throws Exception {
        boolean rv=true;
     ...
     * @throws Exception 异常
     */
    public boolean isCacheable(KeyCache cache, Object[] arguments, Object result) throws Exception {
        boolean rv=true;
